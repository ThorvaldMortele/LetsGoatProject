...
namespace CrazyGames
{
    ...
    {
        private static string sitelockVersion = "1.4.0";
        ...
        public static bool IsOnWhitelistedDomain()
        {
            ...
            var whitelistedDevDomains = new string[] { };
            if (settings != null && settings.whitelistedDomains != null)
            {
                whitelistedDevDomains = settings.whitelistedDomains;
            }

            return IsValidHost(whitelistedDevDomains);
        }
